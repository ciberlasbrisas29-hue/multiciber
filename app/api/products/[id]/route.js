...
export async function DELETE(req, { params }) {
  ...
  try {
    ...
    // NOTA: No eliminamos las imágenes de Cloudinary porque pueden aparecer en reportes históricos
    product.isActive = false;
    await product.save();

    logger.info('Producto desactivado exitosamente (imagen conservada en Cloudinary)', {
